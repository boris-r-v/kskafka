...
public:
    ...
    MongooseConnection( const MongooseConnection& );
...
protected:
    const mg_request_info* getInfo() const;
protected:
...
public:
    ...
    void stop();
    bool isRunning();
    virtual void *handleEvent(ServerHandlingEvent eventCode, struct mg_connection *conn );
    
protected:
    virtual bool on_event(ServerHandlingEvent eventCode, MongooseConnection &connection, const MongooseRequest &request, MongooseResponse &response);
